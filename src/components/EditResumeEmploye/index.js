...
// import { getResumeById, editResume } from '@/app/store/slices/resumeSlice';

// export default function EditResumeEmploye({ resume }) {
...
//             </div>
//             <div className='radio'>
//               {resume.gender && resume.gender === 'Жен' && <input type='radio' onClick={handleGenderChange} name='gender' id='g2' value={'Женский'} checked />}
//               {!resume.gender || resume.gender !== 'Жен' && <input type='radio' onClick={handleGenderChange} name='gender' id='g2' value={'Женский'} />}
